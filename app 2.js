...
var questions = [{//1
  ...
  answers: ["Because of high taxes(taxation without representation)", "Because the British army had stayed in thier homes(boarding, quartering)", "Because they wanted to have self government", "All of the above"],
  correctAnswer: "All of the above"
}, {//37
  ...
  question: "What United States aganecy is responsible for space exploration?",
...
display();
	  ...
	  //$("#panel").append("<button class='answer-button3'>next</button");
...
var queryUrl2 = 'https:translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160317T225805Z.24fe4d3e49b00f5f.6bcc824a7ac0b4ec0da91a97f022d7045d9b121c&text=' +  questions[questionNumber].answers[0] +  '&lang=' + $(event.target).attr("value");
		...
		var lang = $(event.target).attr("value");
		...
		.done(function(response){
			...
			$("#panel").append("<button class='answer-button2' value=" + lang + " data-name='" + questions[questionNumber].answers[0] + "' >" + response.text[0] + "</button>");
...
var queryUrl3 = 'https:translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160317T225805Z.24fe4d3e49b00f5f.6bcc824a7ac0b4ec0da91a97f022d7045d9b121c&text=' +  questions[questionNumber].answers[1] +  '&lang=' + $(event.target).attr("value");
		...
		.done(function(response){
			var result = response.text;
			// console.log(response.text[0]);
				$("#panel").append("<button class='answer-button2' value=" + lang + " data-name='" + questions[questionNumber].answers[1] + "' >" + response.text[0] + "</button>");
...
var queryUrl4= 'https:translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160317T225805Z.24fe4d3e49b00f5f.6bcc824a7ac0b4ec0da91a97f022d7045d9b121c&text=' +  questions[questionNumber].answers[2] +  '&lang=' + $(event.target).attr("value");
		...
		.done(function(response){
			var result = response.text;
				 ...
				 $("#panel").append("<button class='answer-button2' value=" + lang + " data-name='" + questions[questionNumber].answers[2] + "' >" + response.text[0] + "</button>");
...
var queryUrl5 = 'https:translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160317T225805Z.24fe4d3e49b00f5f.6bcc824a7ac0b4ec0da91a97f022d7045d9b121c&text=' +  questions[questionNumber].answers[3] +  '&lang=' + $(event.target).attr("value");
		...
		.done(function(response){
			var result = response.text;
				 ...
				 $("#panel").append("<button class='answer-button2' value=" + lang + " data-name='" + questions[questionNumber].answers[3] + "' >" + response.text[0] + "</button>");
...
$(document).on("click", ".answer-button2", function(e) {
	...
	$("#panel").append("Correct answers: " + correct + "<br>" + "Incorrect answers: " + incorrect + "<br>" );
	$("#panel").append("<button class='answer-button3'>next</button");
	
	if ($(e.target).data("name") === questions[questionNumber].correctAnswer){
    	var queryUrl5 = 'https:translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160317T225805Z.24fe4d3e49b00f5f.6bcc824a7ac0b4ec0da91a97f022d7045d9b121c&text=' +  'Correct' +  '&lang=' + $(event.target).attr("value");
    	...
    	correct++;
   	    ...
   	    var queryUrl5 = 'https:translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160317T225805Z.24fe4d3e49b00f5f.6bcc824a7ac0b4ec0da91a97f022d7045d9b121c&text=' +  'The correct answer is ' + questions[questionNumber].correctAnswer +  '&lang=' + $(event.target).attr("value");
